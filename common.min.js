...
function scrollAndFocus(a, b, c) {
    !function (d) {
        d("body").addClass("scrolling"), d("html, body").animate({scrollTop: d(a).offset().top - (c ? c : 0)}, 300, function () {
...
!function (a) {
    a.extend({
        browserSelector: function () {
            ...
            var b = "ontouchstart" in window || navigator.msMaxTouchPoints, d = navigator.userAgent,
                e = d.toLowerCase(), f = function (a) {
                    return e.indexOf(a) > -1
                }, g = "gecko", h = "webkit", i = "safari", j = "opera", k = document.documentElement,
    ...
    a.fn.visible = function (c, d, e, f) {
        if (!(this.length < 1)) {
            e = e || "both";
            var g = this.length > 1 ? this.eq(0) : this, h = "undefined" != typeof f && null !== f, i = h ? a(f) : b,
                j = h ? i.position() : 0, k = g.get(0), l = i.outerWidth(), m = i.outerHeight(),
            ...
            if ("function" == typeof k.getBoundingClientRect) {
                var o = k.getBoundingClientRect(),
                    ...
                    t = c ? p || q : p && q, u = c ? r || s : r && s, t = o.top < 0 && o.bottom > m ? !0 : t,
                    u = o.left < 0 && o.right > l ? !0 : u;
                if ("both" === e) return n && t && u;
                if ("vertical" === e) return n && t;
                if ("horizontal" === e) return n && u
            } else {
                var v = h ? 0 : j, w = v + m, x = i.scrollLeft(), y = x + l, z = g.position(), A = z.top,
                    B = A + g.height(), C = z.left, D = C + g.width(), E = c === !0 ? B : A, F = c === !0 ? A : B,
                    G = c === !0 ? D : C, H = c === !0 ? C : D;
        ...
        return this.each(function () {
            ...
            f ? b.find("*").addBack().each(function () {
                ...
                b.is("img:has-src") && !b.is("[srcset]") && k.push({
                    ...
                    var d = b.attr(c);
                    return d ? void k.push({src: b.attr("src"), srcset: b.attr("srcset"), element: b[0]}) : !0
                })
    ...
    a.fn.hover3d = function (b) {
        ...
        return a.browser.mobile ? void 0 : this.each(function () {
            ...
            function d(a) {
                var b = g.innerWidth(), d = g.innerHeight(), e = Math.round(a.pageX - g.offset().left),
                    f = Math.round(a.pageY - g.offset().top),
                    i = c.invert ? (b / 2 - e) / c.sensitivity : -(b / 2 - e) / c.sensitivity,
                    j = c.invert ? -(d / 2 - f) / c.sensitivity : (d / 2 - f) / c.sensitivity, k = e - b / 2,
                    l = f - d / 2, m = Math.atan2(l, k), n = 180 * m / Math.PI - 90;
                0 > n && (n += 360), g.css({
            ...
            var f = a(this), g = f.find(c.selector);
            currentX = 0, currentY = 0, c.shine && g.append('<div class="shine"></div>');
            var h = a(this).find(".shine");
            f.css({perspective: c.perspective + "px"}), g.css({perspective: c.perspective + "px"}), h.css({
                position: "absolute",
                top: 0,
                left: 0,
                bottom: 0,
    ...
    a.isFunction(a.fn.hover3d) && a(function () {
        a(".hover-effect-3d").each(function () {
            var b = a(this);
            b.hover3d({selector: ".image-frame"})
        })
    })
    ...
    function c(b) {
        b.each(function () {
            var b = a(this), c = b.text().split(""), d = b.hasClass("is-visible");
    ...
    function d(b) {
        ...
        b.each(function () {
            ...
            }, n); else if (b.hasClass("clip")) {
                var d = b.find(".word-rotator-words"), f = d.width() + 10;
                d.css("width", f)
            } else if (!b.hasClass("type")) {
                var g = b.find(".word-rotator-words b"), h = 0;
                g.each(function () {
                    var b = a(this).width();
                    b > h && (h = b)
    ...
    function e(a) {
        ...
        } else a.parents(".word-rotator").hasClass("clip") ? a.parents(".word-rotator-words").animate({width: "2px"}, s, function () {
            k(a, b), f(b)
    ...
    function f(a, b) {
        a.parents(".word-rotator").hasClass("type") ? (h(a.find("i").eq(0), a, !1, b), a.addClass("is-visible").removeClass("is-hidden")) : a.parents(".word-rotator").hasClass("clip") && a.parents(".word-rotator-words").animate({width: a.width() + 10}, s, function () {
            setTimeout(function () {
                e(a)
            }, t)
        })
    ...
    var l = 2500, m = 3800, n = m - 3e3, o = 50, p = 150, q = 500, r = q + 800, s = 600, t = 1500;
    b()
}), function (a) {
            ...
            if (!c.data("sticky_kit")) {
                ...
                if (s = u = !1, (C = null != j ? j && c.closest(j) : a("<div />")) && C.css("position", c.css("position")), z = function () {
                    ...
                    return !r && (t = !1, null != B && (--B, 0 >= B && (B = m, z(), t = !0)), t || d.height() === w || z(), t = b.scrollTop(), null != v && (l = t - v), v = t, u ? (e && (A = t + p + x > i + g, s && !A && (s = !1, c.css({
                        ...
                        width: "",
                        top: ""
                    }, c.css(a).removeClass(n).trigger("sticky_kit:unstick")), h && (a = b.height(), p + k > a && !s && (x -= l, x = Math.max(a - p, x), x = Math.min(k, x), u && c.css({top: x + "px"})))) : t > o && (u = !0, a = {
                        position: "fixed",
                        top: x
                    }, a.width = "border-box" === c.css("box-sizing") ? c.outerWidth() + "px" : c.width() + "px", c.css(a).addClass(n), null == j && (c.after(C), "left" !== q && "right" !== q || C.append(c)), c.trigger("sticky_kit:stick")), u && e && (null == A && (A = t + p + x > i + g), !s && A)) ? (s = !0, "static" === y.css("position") && y.css({position: "relative"}), c.css({
                        position: "absolute",
                        bottom: f,
                        top: "auto"
    ...
    var b = a(".quantity"), c = b.find(".plus"), d = b.find(".minus");
    c.on("click", function () {
        var b = a(this), c = b.prev();
        c.val(parseInt(c.val()) + 1)
    }), d.on("click", function () {
        var b = a(this), c = b.next();
    ...
    var b = {
        $wrapper: a(".footer-reveal"), init: function () {
            var a = this;
            return a.build(), a.events(), this
        }, build: function () {
            var b = this, c = b.$wrapper.outerHeight(!0), d = a(window).height() - a(".header-body").height();
    ...
    var b = {
        init: function (a) {
            ...
            var b = this, c = b.$wrapper, d = c.data("skew-layer-from"), e = c.data("skew-layer-value");
            return a(window).on("load", function () {
                "right" == d && c.addClass("skew-layer-from-right"), setTimeout(function () {
                    c.css({left: e, transition: "ease left 300ms"})
                }, 300)
            }), this
        }
    };
    ...
    var b = {
        init: function (a) {
            ...
            var b = this, c = b.$wrapper, d = c.data("to"), e = c.data("delay") ? c.data("delay") : 0,
                f = "vertical" == c.data("direction") ? {height: d + "%"} : {width: d + "%"};
            return a(window).on("load scroll", function () {
                c.visible(!0) && a({to: 0}).animate({to: 1}, e, function () {
                    c.css(f)
                })
            }), this
        }
